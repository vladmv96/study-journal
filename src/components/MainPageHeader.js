...
function StudentMainPageHeader({
    ...
    return (
        <div className='mainPageHeader'>
            ...
            <button className='headerNavButton' onClick={() => setCurrentPage(CARDS_ROUTE)}>Предметы</button>
            }
            {role === STUDENT_ROLE &&
              <button className='headerNavButton'  onClick={() => setCurrentPage(HOMEWORKS_ROUTE)}>Домашние задания</button>
            }
